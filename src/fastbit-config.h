...
#define FASTBIT_IBIS_INT_VERSION 2000306
...
#define PACKAGE_BUGREPORT "fastbit-users@hpcrdm.lbl.gov"

/* Define to the full name of this package. */
#define PACKAGE_NAME "FastBit"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "FastBit 2.0.3.6"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "fastbit"

/* Define to the home page for this package. */
#define PACKAGE_URL ""

/* Define to the version of this package. */
#define PACKAGE_VERSION "2.0.3.6"
